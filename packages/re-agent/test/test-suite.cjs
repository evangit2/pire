...
ok(piTuiSrc.includes("0.86.2"), "Pi TUI version is 0.86.2");
...
ok(pkg.version === "0.86.2", `version is 0.86.2 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.2"), "TUI version is 0.86.2");
...
ok(rootPkg.version === "0.86.2", `root package.json version is 0.86.2 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.2", `re-agent package.json version is 0.86.2 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.2"), `tui.ts VERSION is 0.86.2`);

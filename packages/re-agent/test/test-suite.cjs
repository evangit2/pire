...
ok(piTuiSrc.includes("0.86.12"), "Pi TUI version is 0.86.12");
...
ok(pkg.version === "0.86.12", `version is 0.86.12 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.12"), "TUI version is 0.86.12");
...
ok(rootPkg.version === "0.86.12", `root package.json version is 0.86.12 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.12", `re-agent package.json version is 0.86.12 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.12"), `tui.ts VERSION is 0.86.12`);

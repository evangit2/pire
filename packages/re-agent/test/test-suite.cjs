...
ok(piTuiSrc.includes("0.88.6"), "Pi TUI version is 0.88.6");
...
ok(pkg.version === "0.88.6", `version is 0.88.6 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.88.6"), "TUI version is 0.88.6");
...
ok(rootPkg.version === "0.88.6", `root package.json version is 0.88.6 (got ${rootPkg.version})`);
ok(pkg.version === "0.88.6", `re-agent package.json version is 0.88.6 (got ${pkg.version})`);
ok(tuiSrc.includes("0.88.6"), `tui.ts VERSION is 0.88.6`);

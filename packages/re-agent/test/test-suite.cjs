...
ok(piTuiSrc.includes("0.89.17"), "Pi TUI version is 0.89.17");
...
ok(pkg.version === "0.89.17", `version is 0.89.17 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.17"), "TUI version is 0.89.17");
...
ok(rootPkg.version === "0.89.17", `root package.json version is 0.89.17 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.17", `re-agent package.json version is 0.89.17 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.17"), `tui.ts VERSION is 0.89.17`);

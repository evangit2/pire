...
ok(piTuiSrc.includes("0.89.18"), "Pi TUI version is 0.89.18");
...
ok(pkg.version === "0.89.18", `version is 0.89.18 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.18"), "TUI version is 0.89.18");
...
ok(rootPkg.version === "0.89.18", `root package.json version is 0.89.18 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.18", `re-agent package.json version is 0.89.18 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.18"), `tui.ts VERSION is 0.89.18`);

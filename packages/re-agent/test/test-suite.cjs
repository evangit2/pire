...
ok(piTuiSrc.includes("0.86.11"), "Pi TUI version is 0.86.11");
...
ok(pkg.version === "0.86.11", `version is 0.86.11 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.11"), "TUI version is 0.86.11");
...
ok(rootPkg.version === "0.86.11", `root package.json version is 0.86.11 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.11", `re-agent package.json version is 0.86.11 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.11"), `tui.ts VERSION is 0.86.11`);

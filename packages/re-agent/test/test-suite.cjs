...
ok(piTuiSrc.includes("0.88.3"), "Pi TUI version is 0.88.3");
...
ok(pkg.version === "0.88.3", `version is 0.88.3 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.88.3"), "TUI version is 0.88.3");
...
ok(rootPkg.version === "0.88.3", `root package.json version is 0.88.3 (got ${rootPkg.version})`);
ok(pkg.version === "0.88.3", `re-agent package.json version is 0.88.3 (got ${pkg.version})`);
ok(tuiSrc.includes("0.88.3"), `tui.ts VERSION is 0.88.3`);

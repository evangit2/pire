...
ok(piTuiSrc.includes("0.89.8"), "Pi TUI version is 0.89.8");
...
ok(pkg.version === "0.89.8", `version is 0.89.8 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.8"), "TUI version is 0.89.8");
...
ok(rootPkg.version === "0.89.8", `root package.json version is 0.89.8 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.8", `re-agent package.json version is 0.89.8 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.8"), `tui.ts VERSION is 0.89.8`);

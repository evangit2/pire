...
ok(piTuiSrc.includes("0.86.22"), "Pi TUI version is 0.86.22");
...
ok(pkg.version === "0.86.22", `version is 0.86.22 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.22"), "TUI version is 0.86.22");
...
ok(rootPkg.version === "0.86.22", `root package.json version is 0.86.22 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.22", `re-agent package.json version is 0.86.22 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.22"), `tui.ts VERSION is 0.86.22`);

...
ok(piTuiSrc.includes("0.86.4"), "Pi TUI version is 0.86.4");
...
ok(pkg.version === "0.86.4", `version is 0.86.4 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.4"), "TUI version is 0.86.4");
...
ok(rootPkg.version === "0.86.4", `root package.json version is 0.86.4 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.4", `re-agent package.json version is 0.86.4 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.4"), `tui.ts VERSION is 0.86.4`);

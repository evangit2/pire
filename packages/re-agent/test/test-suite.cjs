...
ok(piTuiSrc.includes("0.86.19"), "Pi TUI version is 0.86.19");
...
ok(pkg.version === "0.86.19", `version is 0.86.19 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.19"), "TUI version is 0.86.19");
...
ok(rootPkg.version === "0.86.19", `root package.json version is 0.86.19 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.19", `re-agent package.json version is 0.86.19 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.19"), `tui.ts VERSION is 0.86.19`);

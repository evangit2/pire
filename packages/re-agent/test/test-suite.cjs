...
ok(piTuiSrc.includes("0.86.23"), "Pi TUI version is 0.86.23");
...
ok(pkg.version === "0.86.23", `version is 0.86.23 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.23"), "TUI version is 0.86.23");
...
ok(rootPkg.version === "0.86.23", `root package.json version is 0.86.23 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.23", `re-agent package.json version is 0.86.23 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.23"), `tui.ts VERSION is 0.86.23`);

...
ok(piTuiSrc.includes("0.89.19"), "Pi TUI version is 0.89.19");
...
ok(pkg.version === "0.89.19", `version is 0.89.19 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.19"), "TUI version is 0.89.19");
...
ok(rootPkg.version === "0.89.19", `root package.json version is 0.89.19 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.19", `re-agent package.json version is 0.89.19 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.19"), `tui.ts VERSION is 0.89.19`);

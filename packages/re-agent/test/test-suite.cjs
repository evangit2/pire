...
ok(piTuiSrc.includes("0.89.16"), "Pi TUI version is 0.89.16");
...
ok(pkg.version === "0.89.16", `version is 0.89.16 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.16"), "TUI version is 0.89.16");
...
ok(rootPkg.version === "0.89.16", `root package.json version is 0.89.16 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.16", `re-agent package.json version is 0.89.16 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.16"), `tui.ts VERSION is 0.89.16`);

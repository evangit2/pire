...
ok(piTuiSrc.includes("0.86.21"), "Pi TUI version is 0.86.21");
...
ok(pkg.version === "0.86.21", `version is 0.86.21 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.21"), "TUI version is 0.86.21");
...
ok(rootPkg.version === "0.86.21", `root package.json version is 0.86.21 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.21", `re-agent package.json version is 0.86.21 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.21"), `tui.ts VERSION is 0.86.21`);

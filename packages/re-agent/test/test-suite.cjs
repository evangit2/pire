...
ok(piTuiSrc.includes("0.86.20"), "Pi TUI version is 0.86.20");
...
ok(pkg.version === "0.86.20", `version is 0.86.20 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.20"), "TUI version is 0.86.20");
...
ok(rootPkg.version === "0.86.20", `root package.json version is 0.86.20 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.20", `re-agent package.json version is 0.86.20 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.20"), `tui.ts VERSION is 0.86.20`);

...
ok(piTuiSrc.includes("0.89.9"), "Pi TUI version is 0.89.9");
...
ok(pkg.version === "0.89.9", `version is 0.89.9 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.9"), "TUI version is 0.89.9");
...
ok(rootPkg.version === "0.89.9", `root package.json version is 0.89.9 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.9", `re-agent package.json version is 0.89.9 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.9"), `tui.ts VERSION is 0.89.9`);

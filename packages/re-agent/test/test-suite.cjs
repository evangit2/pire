...
ok(piTuiSrc.includes("0.86.5"), "Pi TUI version is 0.86.5");
...
ok(pkg.version === "0.86.5", `version is 0.86.5 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.5"), "TUI version is 0.86.5");
...
ok(rootPkg.version === "0.86.5", `root package.json version is 0.86.5 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.5", `re-agent package.json version is 0.86.5 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.5"), `tui.ts VERSION is 0.86.5`);

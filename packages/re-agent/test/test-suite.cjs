...
ok(piTuiSrc.includes("0.89.13"), "Pi TUI version is 0.89.13");
...
ok(pkg.version === "0.89.13", `version is 0.89.13 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.13"), "TUI version is 0.89.13");
...
ok(rootPkg.version === "0.89.13", `root package.json version is 0.89.13 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.13", `re-agent package.json version is 0.89.13 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.13"), `tui.ts VERSION is 0.89.13`);

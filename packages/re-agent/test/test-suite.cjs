...
ok(piTuiSrc.includes("0.88.1"), "Pi TUI version is 0.88.1");
...
ok(pkg.version === "0.88.1", `version is 0.88.1 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.88.1"), "TUI version is 0.88.1");
...
ok(rootPkg.version === "0.88.1", `root package.json version is 0.88.1 (got ${rootPkg.version})`);
ok(pkg.version === "0.88.1", `re-agent package.json version is 0.88.1 (got ${pkg.version})`);
ok(tuiSrc.includes("0.88.1"), `tui.ts VERSION is 0.88.1`);

...
ok(piTuiSrc.includes("0.86.0"), "Pi TUI version is 0.86.0");
...
ok(pkg.version === "0.86.0", `version is 0.86.0 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.86.0"), "TUI version is 0.86.0");
...
ok(rootPkg.version === "0.86.0", `root package.json version is 0.86.0 (got ${rootPkg.version})`);
ok(pkg.version === "0.86.0", `re-agent package.json version is 0.86.0 (got ${pkg.version})`);
ok(tuiSrc.includes("0.86.0"), `tui.ts VERSION is 0.86.0`);

...
ok(piTuiSrc.includes("0.89.4"), "Pi TUI version is 0.89.4");
...
ok(pkg.version === "0.89.4", `version is 0.89.4 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.4"), "TUI version is 0.89.4");
...
ok(rootPkg.version === "0.89.4", `root package.json version is 0.88.9 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.4", `re-agent package.json version is 0.88.9 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.4"), `tui.ts VERSION is 0.89.4`);

...
ok(piTuiSrc.includes("0.89.10"), "Pi TUI version is 0.89.10");
...
ok(pkg.version === "0.89.10", `version is 0.89.10 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.10"), "TUI version is 0.89.10");
...
ok(rootPkg.version === "0.89.10", `root package.json version is 0.89.10 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.10", `re-agent package.json version is 0.89.10 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.10"), `tui.ts VERSION is 0.89.10`);

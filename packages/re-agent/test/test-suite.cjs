...
ok(piTuiSrc.includes("0.89.15"), "Pi TUI version is 0.89.15");
...
ok(pkg.version === "0.89.15", `version is 0.89.15 (got ${pkg.version})`);
...
ok(tuiSrc.includes("0.89.15"), "TUI version is 0.89.15");
...
ok(rootPkg.version === "0.89.15", `root package.json version is 0.89.15 (got ${rootPkg.version})`);
ok(pkg.version === "0.89.15", `re-agent package.json version is 0.89.15 (got ${pkg.version})`);
ok(tuiSrc.includes("0.89.15"), `tui.ts VERSION is 0.89.15`);
